   ...
   `OUTPUT(m_axi_awaddr,  ADDR_W), //Address write channel address
   ...
   //write
   `OUTPUT(m_axi_wdata,   DATA_W), //Write channel data
   `OUTPUT(m_axi_wstrb,   DATA_W/8),  //Write channel write strobe
   ...
   `OUTPUT(m_axi_araddr,  ADDR_W), //Address read channel address
   ...
   `INPUT(m_axi_rdata,    DATA_W), //Read channel data
